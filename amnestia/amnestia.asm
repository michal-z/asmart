...
virtual at 0
  ...
  ; opengl32.dll
        ...
        test    rax,rax
        jz      .error
        getwgl  wglCreateContext
        getwgl  wglDeleteContext
        getwgl  wglGetProcAddress
        getwgl  wglMakeCurrent
  ; window class
        xor     ecx,ecx
  ...
  ; opengl context
        ...
        test    eax,eax
        jz      .error_del_ctx
        getgl   wglCreateContextAttribsARB
        mov     rcx,[win_hdc]
        xor     edx,edx
        ...
        getgl   wglSwapIntervalEXT
        xor     ecx,ecx
        call    [wglSwapIntervalEXT]
  ; opengl commands
        getgl   glClear
        getgl   glClearColor
        getgl   glCreateShaderProgramv
        getgl   glDeleteProgram
        getgl   glUseProgramStages
        getgl   glBindProgramPipeline
        getgl   glDeleteProgramPipelines
        getgl   glGenProgramPipelines
        getgl   glDrawArrays
        getgl   glBindVertexArray
        getgl   glDeleteVertexArrays
        getgl   glGenVertexArrays
        mov     eax,1                           ; success
        add     rsp,.k_stack_size
        pop     rsi
        ret
